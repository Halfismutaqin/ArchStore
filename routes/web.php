...
use App\Http\Controllers\Rajaongkir\LocationController;
...
Route::prefix('app')->group(function () {
    Route::middleware(['auth'])->group(function () {
        ...
        Route::prefix('report')->name('report.')->group(function () {
            ...
            Route::post('/transaction', [OrderController::class, 'transaction'])->name('transaction.filter');
        });
    });
});
...
Route::middleware('auth', 'role:user')->group(function () {
    ...
    Route::prefix('transaction')->name('transaction.')->group(function () {
        // update Data transaksi yang sukses :
        Route::get('/update', [TransactionController::class, 'update_transaction'])->name('update_transaction');
...
Route::prefix('api')->name('api.')->group(function () {
    ...
    Route::get('subdistricts/{cityId}', [LocationController::class, 'getSubdistricts']);
});
