        ...
        <div class="col-12">
            @component('components.backend.card.card-form')
                ...
                @slot('content')
                    ...
                    <x-forms.input type="text" class="text-left" name="price" id="price" :label="__('field.price')":isRequired="true" />
...
@push('js')
    <script>
        ...
        priceInput.addEventListener('input', function(e) {
            ...
            const formattedValue = `Rp ${value.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}`; // add commas and Rp
