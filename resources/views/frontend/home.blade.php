        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0 text-white">
                    <div class="categories__item categories__large__item set-bg rounded"
                        data-setbg="{{ asset('me') }}/img/ZedHeroBg.png">
                        <div class="categories__text">
                            <p class="text-lg">Zed Archery merupakan toko panahan yang berlokasi di
                                Jl. Dr. Rajiman No.335, Panularan, Kec. Laweyan, Kota Surakarta, Jawa Tengah 57149</p>
                            <a class="text-white" href="#">
                                <h3> Jelajahi Sekarang </h3>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row m-auto">
                        @foreach ($data['new_categories'] as $category)
                            <div class="col-lg-6 col-md-6 col-sm-6 p-1 rounded shadow-lg">
                                <div class="categories__item set-bg bg-white rounded"
                                    data-setbg="{{ asset('storage/' . $category->thumbnails) }}">
                                    <div class="categories__text">
                                        <h4 class="bg-white rounded"> {{ $category->name }} </h4>
